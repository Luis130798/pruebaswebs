...
const playlistId = '2VhbgfDQHpfzgvD3aliOJq'; // Reemplaza esto con el ID de tu lista de reproducción de Spotify
let token;
let tracks = [];
let currentIndex = 0;
...
const loadPlaylist = async () => {
    ...
    tracks = data.tracks.items.filter(item => item.track.preview_url);
            ...
            <div class="carousel-item">
                <div class="track-item">
                    ...
                    <div class="song-info">
                        ...
                        <div class="controls">
                            <button class="play-preview" data-preview-url="${track.preview_url}" data-index="${index}">
    ...
    // Duplicate the track list for infinite scroll effect
    playlistElement.innerHTML = trackHtml + trackHtml;
